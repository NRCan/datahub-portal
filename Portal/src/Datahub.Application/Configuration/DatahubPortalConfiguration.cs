...
public class DatahubPortalConfiguration
{
    ...
    public string LandingBgFolder { get; set; } = "nrcan";
    ...
    public string ResourcePrefix { get; set; } = "dh";
    public bool CentralizedProjectSecrets { get; set; } = true;
...
{
    public string Profile { get; set; } = "nrcan";
}
